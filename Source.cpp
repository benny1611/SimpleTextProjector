...
//static const char* text = "いろはにほへと　ちりぬるを\nわかよたれそ　つねならむ\nうゐのおくやま　けふこえて\nあさきゆめみし　ゑひもせす\nățâîâîă";
static const char* text = "";
...
int main2(void)
{
    ...
    Font font = LoadFontEx("fonts/Raleway.ttf", 36, codepointsNoDups, codepointsNoDupsCount);
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        else
        {
            ...
            vec2.x = 160.f;
            vec2.y = 110.f;
            DrawTextEx(font, text, vec2, 48, 5, BLACK);
        }
